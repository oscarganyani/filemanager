...
@app.route('/download')
def download():
   return send_file('3-prototype.pdf', as_attachment=True)
...
def uploadfile():
   if request.method == 'POST': # check if the method is post
      ...
      file.save((file.filename)) # this will secure the file
...
#references
#Arpan Neupane (13 march 2021) Python Flask Authentication Tutorial - Learn Flask Login [Source code]. https://github.com/arpanneupane19/Python-Flask-Authentication-Tutorial               